# -*- coding: utf-8 -*-
#
# zug documentation build configuration file, created by
...
breathe_projects = { "zug": "_doxygen/xml" }
breathe_default_project = "zug"
...
html_theme_options = {
    "project_nav_name": "zug",
    "github_link" : "https://github.com/arximboldi/zug",
}
...
latex_documents = [
    (master_doc, 'zug.tex', u'zug Documentation',
...
man_pages = [
    (master_doc, 'zug', u'zug Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zug', u'zug Documentation',
     author, 'zug', 'One line description of project.',
     'Miscellaneous'),
]
